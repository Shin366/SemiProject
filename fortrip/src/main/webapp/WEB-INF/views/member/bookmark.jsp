            ...
            <div class="board-list">
                <c:forEach var="board" items="${boardList}" varStatus="status">
                    <div class="board-card" style="cursor: pointer;" 
                         onclick="location.href='${board.boardType == 'community' ? '/free/view?no=' : '/board/review/detail?reviewNo='}${board.boardNo}'">
                        ...
                        <div class="board-actions">
                            <a href="${board.boardType == 'community' ? '/free/update?no=' : '/board/review/update?reviewNo='}${board.boardNo}" 
                               class="btn-edit" onclick="event.stopPropagation()">
                                수정
                            </a>
                            <a href="${board.boardType == 'community' ? '/free/delete?no=' : '/board/review/delete?reviewNo='}${board.boardNo}" 
                               class="btn-delete" 
